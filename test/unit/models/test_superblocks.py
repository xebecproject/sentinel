...
def go_list_proposals():
    items = [
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "yTC62huR4YQEPn9AJHjnQxxreHSbgAoatV", "payment_amount": 32.01, "start_epoch": 1474261086, "type": 1, "url": "http://xebeccentral.org/fernandez-7625"}]]',
...
def test_deterministic_superblock_creation(go_list_proposals):
    ...
    sb = xebeclib.create_superblock(prop_list, 72000, max_budget, misc.now())
